...
def lapU2(object):
    ...
    #Operator at all four sides
    tN = jp_t(object,Dcent)                 * (np.roll(var,-1,axis=0)-var)/object.dy**2 * (1-object.boundaryym1) - AA*object.grdNu
    tS = jm_t(object,Dcent)                 * (np.roll(var, 1,axis=0)-var)/object.dy**2 * (1-object.boundaryyp1) - AA*object.grdSu  
    tE = np.roll(object.D2[0,:,:],-1,axis=1) * (np.roll(var,-1,axis=1)-var)/object.dx**2 * (1-object.boundaryxm1)
    tW = object.D2[0,:,:]                    * (np.roll(var, 1,axis=1)-var)/object.dx**2 * (1-object.boundary   )
...
def lapV2(object):
    ...
    tN = np.roll(object.D2[0,:,:],-1,axis=0) * (np.roll(var,-1,axis=0)-var)/object.dy**2 * (1-object.boundaryym1) 
    tS = object.D2[0,:,:]                    * (np.roll(var, 1,axis=0)-var)/object.dy**2 * (1-object.boundary   )
    tE = ip_t(object,Dcent)                 * (np.roll(var,-1,axis=1)-var)/object.dx**2 * (1-object.boundaryxm1) - AA*object.grdEv
    tW = im_t(object,Dcent)                 * (np.roll(var, 1,axis=1)-var)/object.dx**2 * (1-object.boundaryxp1) - AA*object.grdWv  
...
def lapU(object):
    ...
    tN = jp_t(object,Dcent)                 * (np.roll(var,-1,axis=0)-var)/object.dy**2 * (1-object.boundaryym1) - AA*object.grdNu
    tS = jm_t(object,Dcent)                 * (np.roll(var, 1,axis=0)-var)/object.dy**2 * (1-object.boundaryyp1) - AA*object.grdSu  
    tE = np.roll(object.D[0,:,:],-1,axis=1) * (np.roll(var,-1,axis=1)-var)/object.dx**2 * (1-object.boundaryxm1)
    tW = object.D[0,:,:]                    * (np.roll(var, 1,axis=1)-var)/object.dx**2 * (1-object.boundary   )
...
def lapV(object):
    ...
    #Operator on all four sides
    tN = np.roll(object.D[0,:,:],-1,axis=0) * (np.roll(var,-1,axis=0)-var)/object.dy**2 * (1-object.boundaryym1) 
    tS = object.D[0,:,:]                    * (np.roll(var, 1,axis=0)-var)/object.dy**2 * (1-object.boundary   )
    tE = ip_t(object,Dcent)                 * (np.roll(var,-1,axis=1)-var)/object.dx**2 * (1-object.boundaryxm1) - AA*object.grdEv
    tW = im_t(object,Dcent)                 * (np.roll(var, 1,axis=1)-var)/object.dx**2 * (1-object.boundaryxp1) - AA*object.grdWv  
...
def convT(object,var):
    ...
    if object.boundop ==1:
        ...
        tN = - (object.Vpos*var                          + object.Vneg*(np.roll(var,-1,axis=0)*object.tmaskym1+var*object.boundaryym1)) / object.dy * object.vmask
        tS =   (object.Vyp1pos*(np.roll(var,1,axis=0)*object.tmaskyp1+var*object.boundaryyp1) + object.Vyp1neg *var                   ) / object.dy * object.vmaskyp1
        tE = - (object.Upos*var                          + object.Uneg*(np.roll(var,-1,axis=1)*object.tmaskxm1+var*object.boundaryxm1)) / object.dx * object.umask
        tW =   (object.Uxp1pos*(np.roll(var,1,axis=1)*object.tmaskxp1+var*object.boundaryxp1) + object.Uxp1neg *var                   ) / object.dx * object.umaskxp1
...
def convU2(object):
    ...
    DE = object.D2xm1     + object.boundaryxm1 * object.D2[1,:,:]
    DW = object.D2[1,:,:] + object.boundary    * object.D2xm1
    ...
    tE = -DE *        object.U2ip           *(object.U2ip - (1-object.signU2)* object.U2[1,:,:] * object.boundaryxm1) /object.dx
    tW =  DW *        object.U2im           *(object.U2im -    object.signU2 * object.U2[1,:,:] * object.boundary   ) /object.dx
...
def convV2(object):
    ...
    DN = object.D2ym1     + object.boundaryym1 * object.D2[1,:,:]
    DS = object.D2[1,:,:] + object.boundary    * object.D2ym1 
    
    tN = -DN *        object.V2jp           *(object.V2jp - (1-object.signV2)* object.V2[1,:,:] * object.boundaryym1) /object.dy
    tS =  DS *        object.V2jm           *(object.V2jm -    object.signV2 * object.V2[1,:,:] * object.boundary   ) /object.dy
...
def convU(object):
    ...
    DE = object.Dxm1     + object.boundaryxm1 * object.D[1,:,:]
    DW = object.D[1,:,:] + object.boundary    * object.Dxm1
    ...
    tE = -DE *        object.Uip           *(object.Uip - (1-object.signU)* object.U[1,:,:] * object.boundaryxm1) /object.dx
    tW =  DW *        object.Uim           *(object.Uim -    object.signU * object.U[1,:,:] * object.boundary   ) /object.dx
...
def convV(object):
    ...
    DN = object.Dym1     + object.boundaryym1 * object.D[1,:,:]
    DS = object.D[1,:,:] + object.boundary    * object.Dym1 
    
    tN = -DN *        object.Vjp           *(object.Vjp - (1-object.signV)* object.V[1,:,:] * object.boundaryym1) /object.dy
    tS =  DS *        object.Vjm           *(object.Vjm -    object.signV * object.V[1,:,:] * object.boundary   ) /object.dy
